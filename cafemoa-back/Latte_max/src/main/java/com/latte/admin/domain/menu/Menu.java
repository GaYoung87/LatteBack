...
public class Menu extends BaseTimeEntity {
    ...
    @Builder
    public Menu(Cafe cafemenu,String mname,String mpic,int isMain,String mtype,int mprice) {
    ...
    public void update(String mname,String mpic,int isMain,String mtype,int mprice) {
        this.mname=mname;
        this.mpic=mpic;
        this.isMain=isMain;
        this.mtype=mtype;
