...
import com.latteback.admin.domain.config.auth.dto.OAuthAttributes;
import com.latteback.admin.domain.config.auth.dto.SessionUser;
import com.latteback.admin.domain.user.User;
import com.latteback.admin.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        //OAuth2 로그인 진행 시 키가 되는 필드 값을 이야기 합니다. Primary Key와 같은 의미입니다.
        ...
        //왜 User 클래스를 쓰지 않고 새로 만들어서 쓰는지는 뒤이어 상세히 설명합니다.
    ...
    private User saveOrUpdate(OAuthAttributes attributes) {
        ...
        //사용자의 이름이나 프로필사진이 변경되면 User 엔티티에도 반영합니다.
    }
